        ...
        public class Proyecto implements ProyectoConstants {
                ...
                public static void main(String args[]) throws ParseException {
                        ...
                        if(errores.equals("")){
                                ...
                                System.out.println("El codigo no se acepta \u005cn");
                                System.out.println(":::Errores:::");
                                System.out.println(errores);
                        }

                        System.out.println("\u005cnIdentificadores::");
...
//Aqui se inicia la grámatica
  ...
  static final public void class_declaration() throws ParseException {
    try {
      ...
      jj_consume_token(class_declaration);
      identificadorClase();
      jj_consume_token(corchetes_abren);
      field_declaration();
      statement();
      jj_consume_token(corchetes_cierran);
      jj_consume_token(0);
    } catch (ParseException e) {
            errores += "Error Lexico:\u005cn"+e.getMessage()+"\u005cn";
    } catch (TokenMgrError e) {
                errores += "Error Sintactico:\u005cn"+e.getMessage()+"\u005cn";
    }
  }
  ...
  static final public void variable_declarator() throws ParseException {
        ...
        String tipo;
        Identificador i;
    identificador = identificadorVariable();
    jj_consume_token(asignador);
    tipo = type();
                i = new Identificador(identificador, tipo, tipoDeDato, "variable_declaration");
                simbolos.add(i);
  }

  static final public String identificadorVariable() throws ParseException {
    jj_consume_token(identifier);
                {if (true) return token.image;}
    throw new Error("Missing return statement in function");
  }

  static final public void identificadorClase() throws ParseException {
    jj_consume_token(identifier);
  ...
  static final public void if_statement() throws ParseException {
    ...
    jj_consume_token(parentesis_abren);
    testing_expresion();
    jj_consume_token(parentesis_cierran);
    aritmetica_expresion();
  }

  static final public void testing_expresion() throws ParseException {
    if (jj_2_5(2)) {
      jj_consume_token(integer_literal);
    } else if (jj_2_6(2)) {
      jj_consume_token(identifier);
  ...
  static final public void aritmetica_expresion() throws ParseException {
    jj_consume_token(corchetes_abren);
    jj_consume_token(identifier);
    jj_consume_token(asignador);
    jj_consume_token(integer_literal);
